...
type MessageContent struct {
	...
	SenderTimestampMS int64     `json:"sender_timestamp_ms,omitempty"`
}
...
type Command struct {
	...
	ReplyToText   string `json:"reply_to_text,omitempty"`   // Text preview of the replied message (optional)
}
